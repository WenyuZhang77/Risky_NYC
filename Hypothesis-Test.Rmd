...
### 3. Do chi-squared test to test suspect gender and level of offense
...
We use Tukey test for pairwise comparison. We notice the p adj for QUEENS-BRONX is 0.3851984, which means their mean values of crime number is very close to each other.
